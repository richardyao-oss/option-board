...
- Temporary earnings watch for target US trading dates 2026-07-16 through 2026-07-21 inclusive: after the compact analysis, make one targeted local lookup of 2026-07-24 expiry contracts for GOOGL, GEV, NOW, INTC, and NOK. Report each symbol even when it is outside the Top candidates, explicitly saying when no clear earnings bet is present. Judge structures before naked legs and include side, size, V/OI or OI change, moneyness, and price/IV behavior when available; treat the result as possible event positioning rather than proof of direction. Keep this lookup bounded and do not expand Futu requests or dump the full raw file. The confirmed earnings dates are July 22 for GOOGL, GEV, and NOW, and July 23 for INTC and NOK.
- Temporary earnings watch for target US trading dates 2026-07-27 through 2026-07-31 inclusive: after the compact analysis, make one targeted local lookup of 2026-07-31 expiry contracts for GLW, BE, SOFI, HOOD, QCOM, and RDDT. Report all six symbols every day even when they are outside the Top candidates or have no qualifying unusual trade. Judge same-minute/equal-quantity structures before naked legs; for unpaired or absent events, separate whole-chain volume/OI/IV positioning from confirmed trade direction. Include side, size, `event_v_oi`, `contract_vo_ratio`, OI change when available, moneyness, IV/price behavior, and whether the evidence looks directional, volatility-driven, protective, or ambiguous. Keep the lookup bounded to these six symbols and this expiry without extra Futu requests beyond the normal daily collection. The confirmed earnings dates are July 28 for GLW and BE, July 29 for SOFI, HOOD, and QCOM, and July 30 for RDDT.
